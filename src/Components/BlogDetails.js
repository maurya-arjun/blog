  ...
  return (
        <>
            <div className='bg-black p-5 space-y-5 lg:m-5 lg:mt-0 md:h-screen lg:h-auto lg:p-10 rounded-br-full'>
                ...
                <h1 className='mt-3 text-4xl text-white font-bold leading-loose md:text-5xl md:leading-loose md:font-serif'>
            ...
            <div className='m-5 md:hidden'>
                <img src={blogImage1} alt='blog-image' className='w-full' />
            </div>
            <div className='md:flex md:mt-10'>
                ...
                <div className='md:w-[70%] md:order-1 md:h-screen md:overflow-y-auto md:border-r'>
                    <div className='hidden m-5 md:block'>
                        <img src={blogImage1} alt='blog-image' className='w-full' />
                    </div>
